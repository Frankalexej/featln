...
import torchaudio
import os
from paths import phone_seg_anno_path, phone_seg_anno_log_path, phone_seg_random_path, phone_seg_random_log_path, phone_seg_random_rec_path
...
if __name__ == "__main__": 
    ...
    open_and_log(phone_seg_random_rec_path, os.path.join(phone_seg_random_log_path, "log.csv"))