...
if __name__ == "__main__":
    for logname in ['phone_anno_test.csv', 
        ...
        src_ = phone_seg_anno_MF_path
        mfcc_tensor = intergate_mfcc(os.path.join(sbsc_use_path, logname), src_)
        mfcc_filename = logname.split(".")[0]
        torch.save(mfcc_tensor, os.path.join(sbsc_use_path, f"{mfcc_filename}.mfcc"))
